...
import io.atomicbits.scraml.ramlparser.model.canonicaltypes.{ BooleanType, CanonicalName, TypeReference }
import io.atomicbits.scraml.ramlparser.model.parsedtypes.{ ParsedBoolean, ParsedType }

/**
  * Created by peter on 30/12/16.
  */
object ParsedBooleanTransformer {
  ...
  def unapply(parsedTypeContext: ParsedTypeContext)
    ...
    parsed match {
      case parsedBoolean: ParsedBoolean => Some((BooleanType, canonicalLookupHelper))
      case _                            => None
    }
  }
