...
import io.atomicbits.scraml.generator.platform.javajackson.{ CommonJavaJacksonPlatform, JavaActionCodeGenerator }

/**
  * Created by peter on 4/11/17.
  */
class AndroidJavaActionCodeGenerator(override val javaJackson: CommonJavaJacksonPlatform) extends JavaActionCodeGenerator(javaJackson) {}
