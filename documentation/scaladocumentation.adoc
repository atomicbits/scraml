...
----
addSbtPlugin("io.atomicbits"      % "scraml-sbt-plugin"   % "0.7.0-M4")
----
...
----
scramlLicenseKey in scraml in Compile :=
  "We, Atomic BITS, use the free scraml license in this project without any intend to serve commercial purposes for ourselves or anyone else."
