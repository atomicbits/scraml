...
----
    <properties>
        <scraml.version>0.7.0-M4</scraml.version>
    </properties>
...
=== Optional: use a license to overcome AGPL limitations
...
=== Optional: use a free license for non-commercial use

In order to use the https://github.com/atomicbits/scraml/blob/develop/LICENSE-EULA[EULA] under its free license conditions, you
can replace the license key in the previous section with the following statement of intend:

[[statement.of.intend]]
[source,java]
.Free license statement of intend
----
<We/I>, <enter name here>, use the free scraml license in this project without any intend to serve commercial purposes for ourselves or anyone else.
----

For example:

[[statement.of.intend.example]]
[source,xml]
.configure a free license statement of intend
----
<configuration>
    <ramlApi>/io/atomicbits/my-api.raml</ramlApi>
    <licenseKey>
        We, Atomic BITS, use the free scraml license in this project without any intend to serve
        commercial purposes for ourselves or anyone else.
    </licenseKey>
    <classHeader>
        All rights reserved.
        This is a custom class header.
